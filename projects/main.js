...
function init() {
   ...
   myMap.events.add("click", e => {
      ...
      coordinates = coords;
      comments.innerHTML = "Отзывов пока нет...Станьте первым=)";
      ...
      if (inputName.value && inputPlace.value && inputText.value) {
         ...
         const newPlacemark = new ymaps.Placemark(
            coordinates,
            {
               ...
               balloonContentBody: `<a onclick="openBalloonFull()" class="balloon__addresslink">${addressLink}</a><br><br>${inputText.value}<br><br>`,
